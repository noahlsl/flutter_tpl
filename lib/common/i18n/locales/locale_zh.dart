...
Map<String, String> localeZh = {
  ...
  LocaleKeys.validatorConfirmPassword: '2次输入密码必须一致',
  LocaleKeys.validatorRegex: '只支持母加数字且以字母开头',
  ...
  // 注册PIN - register pin
  LocaleKeys.pinTitle: '验证',
  LocaleKeys.pinDesc: '我们将向您发送PIN码以继续您的帐户',
  LocaleKeys.pinFormTip: 'Pin',
  LocaleKeys.pinButton: '提交',
  LocaleKeys.pinCodeSendSuccess: '验证码发送成功',
  LocaleKeys.pinCodeSendIncorrect: '验证码发送失败',
  LocaleKeys.pinSuccess: '验证成功',
  LocaleKeys.pinIncorrect: '验证失败',
  ...
  LocaleKeys.tabBarCategory: '分类',
  LocaleKeys.tabBarBookshelf: '书架',
  LocaleKeys.tabBarProfile: '我的',

  // APP AppBar Title
  LocaleKeys.appBarHome: '首页',
  LocaleKeys.appBarCategory: '分类',
  LocaleKeys.appBarCart: '购物车',
  LocaleKeys.appBarProfile: '个人中心',
  // 功能
  LocaleKeys.language: '语言',
  LocaleKeys.languageZh: '简体中文',
  LocaleKeys.languageEn: 'English',
  LocaleKeys.theme: '主题',
  LocaleKeys.themeChange: '主题切换',
  LocaleKeys.themeDark: '暗色主题',
  LocaleKeys.themeLight: '亮色主题',
  LocaleKeys.logout: '退出',
};
